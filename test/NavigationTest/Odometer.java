  ...
  public void run() {
    ...
    while (true) {
      ...
      synchronized (lock) {
        ...
        distL = 3.14159 * NavigationTestMain.WHEEL_RADIUS * (nowTachoL - lastTachoL) / 180;
        distR = 3.14159 * NavigationTestMain.WHEEL_RADIUS * (nowTachoR - lastTachoR) / 180;
        lastTachoL = nowTachoL;
        lastTachoR = nowTachoR;
        deltaD = 0.5 * (distL + distR);
        deltaT = (distL - distR) / NavigationTestMain.TRACK;
